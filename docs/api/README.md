...
| cmd_start             | string                                         | `"ratelimiting"`                                               | The command used to start the BPF program. Usually the userspace eBPF program binary name.                                                                                                     |
| cmd_stop              | string                                         |                                                                | The command used stop the BPF program                                                                                                                                                          |
| cmd_status            | string                                         |                                                                | The command used to get the status of the eBPF program                                                                                                                                         |
| cmd_update            | string                                         |                                                                | The command used to start the program to update eBPF maps dynamically. Usually the userspace eBPF program binary name.                                                                         |
...
| update_args           | map                                            |                                                                | Argument list to update the configuration eBPF maps, the program must have specific logic in place to handle an eBPF map that includes either a JSON object or a custom value type dynamically |
...
| entry_function_name   | string                                         | `_xdp_ratelimiting`                                            | The eBPF program entry function name                                                                                                                                                           |
