...
func ReadConfig(configPath string) (*Config, error) {
	...
	return &Config{
		...
		L3afConfigsgRPCAddr:    util.LoadOptionalConfigString(confReader, "l3af-configs", "rpc-addr", "localhost:58898"),
		L3afConfigsRestAPIAddr: util.LoadOptionalConfigString(confReader, "l3af-configs", "restapi-addr", "localhost:3000"),
	}, nil
}
